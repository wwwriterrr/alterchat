...
export const LoaderIcon: FC<TIconProps> = ({size=24, fill='#000', strokeWidth=3}) => (
    <svg stroke={fill} width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <g>
            <circle cx="12" cy="12" r="9.5" fill="none" strokeWidth={strokeWidth} strokeLinecap="round">
